...
function ScrimObjectiveRow({ objectif, onDelete, onEdit }) {
  ...
  return (
    <div className="group">
      <div className="px-5 py-4 hover:bg-slate-800/40 transition-colors cursor-pointer flex items-center gap-4" onClick={() => navigate(`/performance/team-objectives/${objectif._id}`)}>
