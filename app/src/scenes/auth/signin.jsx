...
import { Shield, Mail, Lock, ArrowRight, Gamepad2, BarChart3, Trophy } from "lucide-react"
    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 p-12 flex-col justify-between relative overflow-hidden">
        ...
        <div className="relative z-10 space-y-8">
          <div>
            <h2 className="text-4xl font-bold text-white mb-4">Track your team's performance</h2>
            <p className="text-slate-400 text-lg">Analyze your scrims, monitor progress, and gain competitive insights.</p>
          </div>
        ...
        <div className="w-full max-w-lg">
          ...
          <div className="space-y-6">
            ...
            <div className="flex justify-end">
              <Link to="/auth/forgot" className="text-sm text-amber-500 hover:text-amber-400 transition-colors">
                Forgot password?
              </Link>
            </div>
            ...
            <p className="text-center text-slate-500">
              ...
              <Link className="text-amber-500 hover:text-amber-400 font-medium transition-colors" to="/auth/signup">
                Create one
              </Link>
            </p>
          </div>
